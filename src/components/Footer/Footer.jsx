		...
		<footer id="footer-container">
            ...
            <div id="footer-cat-container">
                <div className="footer-cat">
                    <span className="footer-cat-title">Les Délices de Katia</span>
                    <span className="footer-cat-msg">Traiteur à Fontainebleau, pour une cuisine raffinée et savoureuse à tous les événements.</span>
                </div>
